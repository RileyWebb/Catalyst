...
namespace Catalyst.Rendering.Vulkan
{
    ...
    public unsafe struct DescriptorSetLayoutBinding
    {
        ...
        /// cref="Catalyst.Rendering.Vulkan.DescriptorType.Sampler"/> or <see
        /// cref="Catalyst.Rendering.Vulkan.DescriptorType.CombinedImageSampler"/> type descriptor, then <see
