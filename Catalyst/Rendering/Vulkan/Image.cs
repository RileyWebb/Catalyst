...
namespace Catalyst.Rendering.Vulkan
{
    ...
    public unsafe struct ImageCreateInfo
    {
        ...
        /// cref="SharingMode"/> is not <see cref="Catalyst.Rendering.Vulkan.SharingMode.Concurrent"/>).
        /// </summary>
    ...
    public struct ImageFormatProperties
    {
        ...
        /// <summary>
        /// A bitmask of <see cref="Catalyst.Rendering.Vulkan.SampleCounts"/> specifying all the supported sample
