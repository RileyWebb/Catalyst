...
namespace Catalyst.Windowing.SDL2
{
    ...
    public unsafe struct TextEditingEvent
    {
        ...
        public uint Timestamp;
        public uint WindowID;
        public fixed byte Text[Windowing.SDL2.SDL.TEXTEDITINGEVENT_TEXT_SIZE];
        public int Start;
        public int Length;
    }
    ...
    public unsafe struct TextInputEvent
    {
        ...
        public uint Timestamp;
        public uint WindowID;
        public fixed byte Text[Windowing.SDL2.SDL.TEXTINPUTEVENT_TEXT_SIZE];
    }
    ...
    internal static unsafe partial class SDL
    {
        ...
        public static extern int PeepEvents(Event* events, int numevents, EventAction action, EventType minType,
            EventType maxType);

        [DllImport(LibraryName, EntryPoint = "SDL_PeepEvents", CallingConvention = CallingConvention.Cdecl)]
        public static extern int PeepEvents([Out] Event[] events, int numevents, EventAction action, EventType minType,
            EventType maxType);
