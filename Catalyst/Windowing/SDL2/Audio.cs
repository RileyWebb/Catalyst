...
*/
    ...
    */
    ...
    {
        [DllImport(SDL.LibraryName, EntryPoint = "SDL_RWFromFile", CallingConvention = CallingConvention.Cdecl,
        ...
        [DllImport(SDL.LibraryName, EntryPoint = "SDL_LoadWAV_RW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(SDL.LibraryName, EntryPoint = "SDL_LoadWAV_RW", CallingConvention = CallingConvention.Cdecl)]
        public static extern AudioSpec* LoadWavRW(RWops src, int freesrc, ref AudioSpec audioSpec, out IntPtr buf,
            out int len);
        ...
        [DllImport(SDL.LibraryName, EntryPoint = "SDL_GetNumAudioDrivers", CallingConvention = CallingConvention.Cdecl,
            SetLastError = true)]
        public static extern int GetNumAudioDrivers();


        [DllImport(SDL.LibraryName, EntryPoint = "SDL_GetAudioDriver", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, SetLastError = true)]
        public static extern IntPtr GetAudioDriver(int index);


        [DllImport(SDL.LibraryName, EntryPoint = "SDL_OpenAudioDevice", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, SetLastError = true)]
        public static extern uint OpenAudioDevice(string device, int iscapture, AudioSpec* desired, AudioSpec* obtained,
            int allowChanges);

        [DllImport(SDL.LibraryName, EntryPoint = "SDL_OpenAudioDevice", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, SetLastError = true)]
        public static extern uint OpenAudioDevice(string device, int iscapture, ref AudioSpec desired,
            out AudioSpec obtained, int allowChanges);

        [DllImport(SDL.LibraryName, EntryPoint = "SDL_CloseAudioDevice", CallingConvention = CallingConvention.Cdecl,
            SetLastError = true)]
        public static extern uint CloseAudioDevice(uint deviceId);

        [DllImport(SDL.LibraryName, EntryPoint = "SDL_PauseAudioDevice", CallingConvention = CallingConvention.Cdecl,
            SetLastError = true)]
        public static extern int PauseAudioDevice(uint deviceId, bool pauseOn);

        [DllImport(SDL.LibraryName, EntryPoint = "SDL_FreeWave", SetLastError = true)]
        public static extern int FreeWave(byte* buf);


        [DllImport(SDL.LibraryName, EntryPoint = "SDL_QueueAudio", SetLastError = true)]
        ...
        [DllImport(SDL.LibraryName, EntryPoint = "SDL_Delay", SetLastError = true)]
        public static extern void Delay(uint ms);

        [DllImport(SDL.LibraryName, EntryPoint = "SDL_GetTicks", CallingConvention = CallingConvention.Cdecl)]
        public static extern uint GetTicks();

        [DllImport(SDL.LibraryName, EntryPoint = "SDL_memcpy", SetLastError = true)]
        ...
        [DllImport(SDL.LibraryName, EntryPoint = "SDL_WriteToDataQueue", SetLastError = true)]
        ...
        [DllImport(SDL.LibraryName, EntryPoint = "SDL_GetQueuedAudioSize", SetLastError = true)]
        public static extern uint GetQueuedAudioSize(uint deviceId);

        [DllImport(SDL.LibraryName, EntryPoint = "SDL_ClearQueuedAudio", SetLastError = true)]
