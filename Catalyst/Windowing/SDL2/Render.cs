...
namespace Catalyst.Windowing.SDL2
{
    ...
    internal static unsafe partial class SDL
    {
        ...
        [DllImport(LibraryName, EntryPoint = "SDL_CreateWindowAndRenderer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern int CreateWindowAndRenderer(int width, int height, WindowFlags window_flags,
            Window* window, Renderer* renderer);

        [DllImport(LibraryName, EntryPoint = "SDL_CreateWindowAndRenderer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern int CreateWindowAndRenderer(int width, int height, WindowFlags window_flags,
            out Window window, out Renderer renderer);
        ...
        [DllImport(LibraryName, EntryPoint = "SDL_QueryTexture", CallingConvention = CallingConvention.Cdecl)]
        public static extern int QueryTexture(Texture texture, out uint format, out TextureAccess access, out int w,
            out int h);
        ...
        public static extern int RenderCopyEx(Renderer renderer, Texture texture, Rect* srcrect, Rect* dstrect,
            double angle, Point* center, RendererFlip flip);

        [DllImport(LibraryName, EntryPoint = "SDL_RenderCopyEx", CallingConvention = CallingConvention.Cdecl)]
        public static extern int RenderCopyEx(Renderer renderer, Texture texture, IntPtr srcrect, IntPtr dstrect,
            double angle, IntPtr center, RendererFlip flip);

        [DllImport(LibraryName, EntryPoint = "SDL_RenderCopyEx", CallingConvention = CallingConvention.Cdecl)]
        public static extern int RenderCopyEx(Renderer renderer, Texture texture, ref Rect srcrect, ref Rect dstrect,
            double angle, ref Point center, RendererFlip flip);
        ...
        [DllImport(LibraryName, EntryPoint = "SDL_RenderReadPixels", CallingConvention = CallingConvention.Cdecl)]
        public static extern int RenderReadPixels(Renderer renderer, ref Rect rect, uint format, IntPtr pixels,
            int pitch);
        ...
        public static extern int UpdateYUVTexture(Texture texture, Rect* rect, byte* Yplane, int Ypitch, byte* Uplane,
            int Upitch, byte* Vplane, int Vpitch);

        [DllImport(LibraryName, EntryPoint = "SDL_UpdateYUVTexture", CallingConvention = CallingConvention.Cdecl)]
        public static extern int UpdateYUVTexture(Texture texture, ref Rect rect, IntPtr Yplane, int Ypitch,
