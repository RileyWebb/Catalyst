...
namespace Catalyst.Windowing.SDL2
{
    ...
    internal static unsafe partial class SDL
    {
        ...
        [DllImport(LibraryName, EntryPoint = "SDL_GetRGBA", CallingConvention = CallingConvention.Cdecl)]
        public static extern void GetRGBA(uint pixel, PixelFormat* format, out byte r, out byte g, out byte b,
            out byte a);
        ...
        public static extern bool PixelFormatEnumToMasks(uint format, int* bpp, uint* Rmask, uint* Gmask, uint* Bmask,
            uint* Amask);

        [DllImport(LibraryName, EntryPoint = "SDL_PixelFormatEnumToMasks", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool PixelFormatEnumToMasks(uint format, out int bpp, out uint Rmask, out uint Gmask,
