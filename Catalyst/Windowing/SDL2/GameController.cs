...
namespace Catalyst.Windowing.SDL2
{
    ...
    public struct GameControllerButtonBindUnion
    {
        ...
        [FieldOffset(0)] public HatStruct Hat;
    ...
    internal static unsafe partial class SDL
    {
        [DllImport(LibraryName, EntryPoint = "SDL_GameControllerAddMapping",
            CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false,
        ...
        [DllImport(LibraryName, EntryPoint = "SDL_GameControllerGetBindForAxis",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern GameControllerButtonBind GameControllerGetBindForAxis(GameController gameController,
            GameControllerAxis axis);

        [DllImport(LibraryName, EntryPoint = "SDL_GameControllerGetBindForButton",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern GameControllerButtonBind GameControllerGetBindForButton(GameController gameController,
            GameControllerButton buttons);
