...
namespace Catalyst.Windowing.SDL2
{
    ...
    internal static unsafe partial class SDL
    {
        ...
        public static extern DisplayMode* GetClosestDisplayMode(int displayIndex, DisplayMode* mode,
            DisplayMode* closest);

        [DllImport(LibraryName, EntryPoint = "SDL_GetClosestDisplayMode", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr GetClosestDisplayMode(int displayIndex, ref DisplayMode mode,
        ...
        [DllImport(LibraryName, EntryPoint = "SDL_GetWindowBordersSize", CallingConvention = CallingConvention.Cdecl)]
        public static extern int GetWindowBordersSize(Window window, out int top, out int left, out int bottom,
            out int right);
